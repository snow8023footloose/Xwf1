<template>
  <div class="goods">
    ...
    <el-dialog width="80%" title="分类编辑" :visible.sync="dialogFormVisibleClassesEdit">
      <el-form :model="form">
        <el-form-item label="排序/权重" :label-width="formLabelWidth">
          <el-input v-model="form.content" auto-complete="off" placeholder="请输入数字"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form">
    ...
    <el-dialog width="80%" title="SKU编辑" :visible.sync="dialogFormVisibleInSKUEdit">
      ...
      <el-form :model="form">
        <el-form-item label="加价" :label-width="formLabelWidth">
          <el-input v-model="form.content" auto-complete="off" placeholder="请输入价格"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
      ...
      <div class="matter2">
        ...
        <el-form :model="form">
          <el-form-item label="菜品类型" :label-width="formLabelWidth" style="text-align: left">
            <el-select v-model="value4" clearable placeholder="请选择，默认一般菜品">
              <el-option
        ...
        <el-form :model="form">
          <el-form-item label="添加SKU" :label-width="formLabelWidth">
            <el-select v-model="value5" multiple placeholder="请选择，默认无SKU">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
        ...
        <el-form :model="form">
          <el-form-item label="添加标签" :label-width="formLabelWidth">
            <el-select v-model="value6" multiple placeholder="请选择，默认无标签">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
